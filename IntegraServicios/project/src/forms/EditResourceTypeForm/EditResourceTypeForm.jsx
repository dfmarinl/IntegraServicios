...
import "./EditResourceTypeForm.css";

const EditResourceTypeForm = ({ resourceType, units, onSuccess, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="edit-resource-type-form">
