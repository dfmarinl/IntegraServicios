      ...
      <div className="resources-overview">
        ...
        <div className="resources-list">
          {displayedResources.map((resource) => {
            // Acceder correctamente a ResourceType y Unit
            const resourceType =
              resource.ResourceType ||
              allResourceTypes.find((t) => t.id === resource.typeId);
            ...
            return (
              <Card key={resource.id} className="resource-card">
                ...
                <div className="resource-meta">
                  ...
                  {resource.features &&
                    Object.keys(resource.features).length > 0 && (
                      <div className="resource-features">
                        <strong>Características:</strong>
                        <ul className="features-list">
                          {Object.entries(resource.features).map(
                            ([key, value]) => (
                              <li key={key}>
